...
This policy applies to **`Kenearos/Testapp`**. It is derived from our engineering
...
1. Email **kenearos@googlemail.com** with the subject prefix `[SECURITY] Testapp`.
